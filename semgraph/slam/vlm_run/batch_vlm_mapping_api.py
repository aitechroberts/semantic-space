...
from semgraph.utils.logging_metrics import MappingTracker
from semgraph.utils.optional_wandb_wrapper import OptionalWandB
from semgraph.utils.general_utils import (
    ObjectClasses,
    cfg_to_dict,
...
from semgraph.slam.utils import process_cfg, processing_needed
from semgraph.slam.geometry import get_geometry_backend

from semgraph.stages import detect as detect_stage
from semgraph.stages import caption as caption_stage
from semgraph.stages import build_map as build_map_stage
from semgraph.stages import postprocess as postprocess_stage
from semgraph.stages.paths import _resolve_output_base, _build_exp_path
...
def main(cfg: DictConfig):
    ...
    for loop_idx in trange(total_iterations):
        ...
        if detection_list is None and raw_gobs is not None:
            from semgraph.slam.utils import filter_gobs, resize_gobs
        ...
        if cfg.save_objects_all_frames:
            from semgraph.utils.general_utils import save_objects_for_frame
