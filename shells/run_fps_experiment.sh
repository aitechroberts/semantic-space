...
# =============================================================================
# Tunable FPS-pose experiment runner for detect_sam3 + GroundingDINO
#
...
# Defaults to batch matching mode (correct for FPS-selected diverse viewpoints).
#
# Usage:
...
# --- Matching mode (batch is correct for FPS) ---
MATCHING_MODE="${MATCHING_MODE:-batch}"

# --- Stage 1: Detection-to-object matching ---
SIM_THRESH="${SIM_THRESH:-1.4}"
...
[[ "$MATCHING_MODE"        != "batch" ]] && TAG="${TAG}_${MATCHING_MODE}"
